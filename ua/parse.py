...
def variableNodes(ctx, variables):
	#####################################################################

	for variable in variables:
		#############################################################

		for node1 in variable.childNodes:
	...
	if debug and ctx.verbose:
		...
		print('| VARIABLES                                                                 |')
		print('-----------------------------------------------------------------------------')
		ua.utils.displayTree(ctx.variables)
		print('-----------------------------------------------------------------------------')
...
def fuseNodes(ctx, fuses):
	...
	for fuse in fuses:
		...
		KEYS.append({'name': 'disable', 'opt': 'EmPtY'})
